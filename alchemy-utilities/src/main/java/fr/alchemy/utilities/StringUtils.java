...
/**
 * <code>StringUtils</code> provides utility functions to manipulate, extract or
 * create {@link String}.
 * 
 * @version 0.2.0
 * @since 0.2.0
...
public class StringUtils {
	...
	/**
	 * The EOL (End Of Line) character to specify the end of a line of text. Note
	 * that it's value isn't system dependant like {@link System#lineSeparator()}.
	 */
	...
	/**
	 * Return whether the provided {@link String} contains at least one of the
	 * provided characters.
	 * 
