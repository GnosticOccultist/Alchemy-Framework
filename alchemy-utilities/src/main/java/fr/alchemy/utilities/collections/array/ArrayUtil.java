...
/**
 * <code>ArrayUtil</code> provides utility functions to manipulate or
 * instantiates {@link Collection} and {@link Array}.
 * 
 * @version 0.2.0
 * @since 0.1.0
 * 
...
public final class ArrayUtil {
	...
	/**
	 * Create a new array with the specified element type that it will contain and
	 * of the given size.
	 * 
	 * @param <E>  The element's type contained in the array.
	 * 
	 * @param type The type of element which will be contained in the array (not
	 *             null).
	...
	/**
	 * Create and return a copy of the given array with the provided added capacity
	 * compared to its original size.
	 * 
	 * @param <E>      The element's type contained in the array.
	 * 
	 * @param original The type of element which will be contained in the array (not
	 *                 null).
	 * @param added    The amount of size to add to the copy (&ge;0).
	 * @return A copy of the given array with the desired incremented size (not
	 *         null).
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * Performs the provided {@link Consumer} for all the elements of the given
	 * array.
	 * 
	 * @param <E>      The element's type contained in the array.
	 * 
	...
	/**
	 * Performs an in-place shellsort (extension of insertion sort) of the provided
	 * array using the specified {@link Comparator} to sort the array elements.
	 * 
	 * @param <E>   The element's type contained in the array.
	 * 
	 * @param array The array to sort (not null).
	 * @param left  The left index of the range to sort (&ge;0, &lt;array.length).
	 * @param right The right index (inclusive) of the range to sort (&ge;0,
	 *              &lt;array.length).
	...
	/**
	 * Performs an in-place shellsort (extension of insertion sort) of the provided
	 * array using the {@link Comparable} interface to sort the array elements.
	 * 
	 * @param <E>   The element's type contained in the array and implementing
	 *              {@link Comparable}.
	 * 
	 * @param array The array to sort (not null).
	 * @param left  The left index of the range to sort (&ge;0, &lt;array.length).
	...
	/**
	 * Convert the provided {@link fr.alchemy.utilities.collections.array.Array
	 * Array} into a readable string representation.
	 * 
	 * @param <E>   The element's type contained in the array.
	 * 
